...
namespace DAL.EntityModels
{
    public partial class EMS_ITCContext : DbContext
    {
        ...
        public virtual DbSet<Dum> Da { get; set; } = null!;
        ...
        public virtual DbSet<MenuPermissionAssign> MenuPermissionAssigns { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-URSATJE;Database=EMS_ITC;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Dum>(entity =>
            {
                entity.ToTable("Dum");
            ...
            modelBuilder.Entity<MenuPermissionAssign>(entity =>
            {
                entity.ToTable("Menu_Permission_Assign");
                ...
                entity.Property(e => e.MenuListId).HasColumnName("Menu_List_id");

                entity.Property(e => e.RoleId).HasColumnName("Role_id");

                entity.HasOne(d => d.MenuList)
                    .WithMany(p => p.MenuPermissionAssigns)
                    .HasForeignKey(d => d.MenuListId)
                    .HasConstraintName("FK_Menu_Permission_Assign_Menu_List1");

                entity.HasOne(d => d.MenuListNavigation)
                    .WithMany(p => p.MenuPermissionAssigns)
                    .HasForeignKey(d => d.MenuListId)
                    .HasConstraintName("FK_Menu_Permission_Assign_Menu_List");

                entity.HasOne(d => d.Role)
                    .WithMany(p => p.MenuPermissionAssigns)
                    .HasForeignKey(d => d.RoleId)
                    .HasConstraintName("FK_Menu_Permission_Assign_Roles");
            });
